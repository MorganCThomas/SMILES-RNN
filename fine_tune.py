...
def main(args):
    ...
    for e in range(1, args.n_epochs + 1):
        ...
        with torch.no_grad():
            ...
            if len(mols) > 0:
                utils.add_mols(writer, 'Molecules sampled', mols[:10], mols_per_row=5, global_step=e)
